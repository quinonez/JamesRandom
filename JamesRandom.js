...
function JamesRandom( args ){
  ...
  this.Name = function(){ return "HepJamesRandom"; };
  ...
  this.FlatArray = function( size, vect ){
    var i;
  ...
  this.SetSeed = function( seed, dum ){
  ...
  this.SetSeeds = function( seeds, dum ){
